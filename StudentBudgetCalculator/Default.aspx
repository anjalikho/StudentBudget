                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="row" style="border: 1px solid red;">
                                ...
                                <div class="col-md-6 form-row" style="border: 1px solid white;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-row">
                                    ...
                                    <asp:CompareValidator ID="cvPartTimeW" runat="server" ControlToValidate="tbPartTimeW" Type="Currency"
                                        Operator="DataTypeCheck" Text="*" ErrorMessage="Part Time Work" CssClass="text-nowrap text-validator"></asp:CompareValidator>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 form-row">
                                ...
                                <div class="col-md-6 form-row">
                                    ...
                                    <asp:CompareValidator ID="cvScholarG" runat="server" ControlToValidate="tbScholarG" Type="Currency"
                                        Operator="DataTypeCheck" Text="*" ErrorMessage="Scholorships/Grants" CssClass="text-nowrap text-validator"></asp:CompareValidator>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 form-row">
                                ...
                                <div class="col-md-6 form-row">
                                    ...
                                    <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="tbIncomeOthers" Type="Currency"
                                        Operator="DataTypeCheck" Text="*" ErrorMessage="Other Income" CssClass="text-nowrap text-validator"></asp:CompareValidator>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-row">
                                    ...
                                    <asp:CompareValidator ID="cvTutionF" runat="server" ControlToValidate="tbTutionF" Type="Currency"
                                          Operator ="DataTypeCheck" Text="*" ErrorMessage="Tution Fees" CssClass="text-nowrap text-validator"></asp:CompareValidator>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 form-row">
                                ...
                                <div class="col-md-6 form-row">
                                    ...
                                    <asp:CompareValidator ID="cvAccomadation" runat="server" ControlToValidate="tbAccomadation" Type="Currency"
                                        Operator="DataTypeCheck" Text="*" ErrorMessage="Accomadation " CssClass="text-nowrap text-validator"></asp:CompareValidator>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 form-row">
                                ...
                                <div class="col-md-6 form-row">
                                    ...
                                    <asp:CompareValidator ID="cvFood" runat="server" ControlToValidate="tbFood" Type="Currency"
                                        Operator="DataTypeCheck" Text="*" ErrorMessage="Food" CssClass="text-nowrap text-validator"></asp:CompareValidator>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 form-row">
                                ...
                                <div class="col-md-6 form-row">
                                    ...
                                    <asp:CompareValidator ID="cvTransport" runat="server" ControlToValidate="tbTransport" Type="Currency"
                                        Operator="DataTypeCheck" Text="*" ErrorMessage="Transport " CssClass="text-nowrap text-validator"></asp:CompareValidator>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 form-row">
                                ...
                                <div class="col-md-6 form-row">
                                    ...
                                    <asp:CompareValidator ID="cvHouseholdB" runat="server" ControlToValidate="tbHouseholdB" Type="Currency"
                                        Operator="DataTypeCheck" Text="*" ErrorMessage="HouseholdBills" CssClass="text-nowrap text-validator"></asp:CompareValidator>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 form-row">
                                ...
                                <div class="col-md-6 form-row">
                                    ...
                                    <asp:CompareValidator ID="cvOthers" runat="server" ControlToValidate="tbExpOthers" Type="Currency"
                                        Operator="DataTypeCheck" Text="*" ErrorMessage="Others" CssClass="text-nowrap text-validator"></asp:CompareValidator>
                                </div>
                            </div>
                        </div>                                    
                    </div>
